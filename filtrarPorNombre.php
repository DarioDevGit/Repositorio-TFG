...
function crea_query(){
    ...
    var busq="<?php echo $busqueda ?>";

    return "busqueda="+encodeURIComponent(busq);
}
...
function mostrarPelicula(){
	if(ajax.readyState==4 && ajax.status==200){
        ...
        for(var x=0;x<objeto_json.length;x++){
            ...
            txt=txt+"<table style='margin-left:1%;'><tr><td colspan='2'><b>Titulo:</b>"+titulo+"</td></tr><tr><td><a href='./muestraInfoPelis.php?id="+id+"'><img src='./imagenes/"+foto+"' style='width:100px; height:160px;'></a></td><td><b>Sinopsis:</b>"+descripcion+"</td></tr></table><br>";
        }
        document.getElementById("tituloPeli").innerHTML="Filtrado por: <?php echo $busqueda ?>";
...
<body onload="MostrarConsulta('muestraPeliPorNombre.php'); return false">
...
function mostrarPelicula(){
    if(ajax.readyState==4 && ajax.status==200){
        ...
        document.getElementById("filtrado").innerHTML="Filtrado por: <?php echo $_POST['busqueda']; ?>";
        document.getElementById("peliculas").innerHTML=txt;
