...
function crea_query(){
    ...
    if(<?php echo $genero ?>==1){
        genero="Accion";
    }

    if(<?php echo $genero ?>==2){
        genero="Comedia";
    }

    if(<?php echo $genero ?>==3){
        genero="Ciencia";
    }

    if(<?php echo $genero ?>==4){
        genero="Terror";
    }

    if(<?php echo $genero ?>==5){
        genero="Drama";
    }

    if(<?php echo $genero ?>==6){
        genero="Romance";
    }
...
function mostrarPelicula(){
    if(ajax.readyState==4 && ajax.status==200){
        ...
        document.getElementById("tituloPeli").innerHTML=genero;
...
<body onload="MostrarConsulta('muestraPeliPorGenero.php'); return false">
