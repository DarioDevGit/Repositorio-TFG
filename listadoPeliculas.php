...
function MostrarConsulta(datos){
	...
	ajax.open("GET", datos);
	ajax.onreadystatechange=listadoPeliculas;
	ajax.send(null);
}
...
function listadoPeliculas(){
	if(ajax.readyState==4 && ajax.status==200){
        ...
        txt=txt+"<table><tr><th>Título</th><th>Descripción</th><th>Foto</th><th>¿Modificar?</th><th>¿Eliminar?</th></tr>";
        ...
        for(var x=0;x<objeto_json.length;x++){
            ...
            txt=txt+"<tr><td>"+titulo+"</td><td>"+descripcion+"</td><td><img src='./imagenes/"+foto+"' style='width:100px; height:160px;' /></td><td style='text-align:center;'><a href='./modificarPelicula.php?id="+id+"'><span class='glyphicon glyphicon-pencil'></span></a></td><td style='text-align:center;'><a href='./eliminarPelicula.php?id="+id+"'><span class='glyphicon glyphicon-trash'></span></a></td></tr>";
        }
